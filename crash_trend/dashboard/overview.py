...
function renderReleaseDecisions() {
  ...
  let pinned = "";
  grid.innerHTML = DECISION_PLATFORMS.map(pf => {
    ...
    const release = requested || latest;
    return buildReleaseDecisionCardHtml(pf.key, pf.label, release, {
